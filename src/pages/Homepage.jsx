    ...
    <div className='flex flex-col gap-4'>
      <div className='flex gap-4 justify-center mt-8'>
        <span className='w-[30%] flex flex-col justify-center gap-1 items-center rounded-xl shadow p-2 h-[200px] shadow-2xl'>
            <img src="https://www.knit.ac.in/images/governor.jpg" alt=""
            className='w-24 h-24 rounded-full' />
            <p className='text-red-500 font-bold'>Smt. Anandiben Patel</p>
            <p>Hon'ble Governor, Uttar Pradesh</p>
        </span>
        <span className='w-[30%] flex flex-col justify-center gap-1 items-center rounded-xl shadow p-2 h-[200px] shadow-2xl'>
            <img src="https://www.knit.ac.in/site/writereaddata/siteContent/202305181556346961VC_180523.jpg" alt=""
            className='w-24 h-24 rounded-full' />
        ...
        <span className='w-[30%] flex flex-col justify-center gap-1 items-center rounded-xl shadow p-2 h-[200px] shadow-2xl'>
            <img src="https://www.knit.ac.in/site/writereaddata/siteContent/202309141441549669director-new.jpg" alt=""
            className='w-24 h-24 rounded-full' />
      ...
      <div className='px-4'>
        ...
        <span className=' flex gap-4 px-4 mt-4'>
            ...
            <span className='flex flex-col py-8 px-3 rounded-lg items-center w-[200px] gap-2 shadow-2xl'>
                ...
                <p className='text-sm font-semibold'>Additional Professor In-charge</p>
                <p>+919532888592 </p>
            </span>
        ...
        <span className='flex flex-wrap gap-2 mt-4 px-4 px-2'>
            {
                partners.map(function(partner){
                    return <div className='border overflow-hidden rounded-lg'>
