...
export default function PostJob() {
    ...
    const addingJobToDB = function(){
      ...
      formData.append('position' , postJob.position)
      formData.append('company' , postJob.company)
      formData.append('package' , postJob.package)
      formData.append('googleForm' , postJob.googleForm)
  ...
  return (
    <div className='flex items-center text-gray-500 flex-col gap-2 bg-gray-300 rounded-xl p-4'>
      <span className='flex flex-col gap-1'>
        ...
        <input required name='position' value={postJob.position} onChange={handleChange} type="text" placeholder='Enter the role' className='border w-[400px] h-[40px] rounded-xl px-4 focus:outline-blue-400' />
      </span>
      <span className='flex flex-col gap-1'>
      ...
      <span className='flex flex-col gap-1'>
        ...
        <input required type="text" name='package' value={postJob.package} onChange={handleChange} placeholder='Enter the role' className='border w-[400px] h-[40px] rounded-xl px-4 focus:outline-blue-400' />
      </span>
      <span className='flex flex-col gap-1'>
      ...
      <span className='flex flex-col gap-1'>
        ...
        <input type="text" required value={postJob.googleForm} onChange={handleChange} name='googleForm' placeholder='Enter URL' className='border w-[400px] bg-white pt-1 h-[40px] rounded-xl px-4 focus:outline-blue-400' />
      </span>
